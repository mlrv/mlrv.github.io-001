...
(function () {
  ...
  Ansi = (function () {
    ...
    Ansi.prototype._remove = function () {
      ...
      klasses = arguments.length >= 1 ? __slice.call(arguments, 0) : []
      _results = []
  ...
  JQConsole = (function () {
    ...
    */
    ...
    JQConsole.prototype._CheckKeyCode = function (key_code) {
      ...
      if (!((key_code > 0 && key_code < 256)) || isNaN(key_code)) {
    ...
    */
      ...
      if (shift) {
        ...
        continuation = function (indent) {
          ...
          if (indent !== false) {
            ...
            _results = []
            for (_ = _i = 0, _ref = Math.abs(indent); _ref >= 0 ? _i < _ref : _i > _ref; _ = _ref >= 0 ? ++_i : --_i) {
              if (indent > 0) {
    ...
    JQConsole.prototype._Indent = function () {
      ...
      return this.$prompt_left.prepend((function () {
        ...
        _results = []
        for (_ = _i = 1, _ref = this.indent_width; _ref >= 1 ? _i <= _ref : _i >= _ref; _ = _ref >= 1 ? ++_i : --_i) {
          _results.push(' ')
        }
        return _results
      }.call(this)).join(''))
    ...
    JQConsole.prototype._WalkCharacters = function (text, char, opposing_char, current_count, back) {
      ...
      read_char = function () {
        ...
        if (back) {
          _ref = text, text = _ref.length >= 2 ? __slice.call(_ref, 0, _i = _ref.length - 1) : (_i = 0, []), ret = _ref[_i++]
        } else {
          _ref1 = text, ret = _ref1[0], text = _ref1.length >= 2 ? __slice.call(_ref1, 1) : []
        }
        if (ret) {
